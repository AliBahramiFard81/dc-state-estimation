...
%power_information(:,3) = power_information(:,3) * 1.25;

% creating deviation for powers so they wouldn't be like the load flow
% values
power_deviation = randn(length(power_information(:,3)),1) * sigma_pu;
power_information(:,3) = power_information(:,3) + power_deviation(:,1);
...
fprintf('\n\t\t----------------------------------------------------------------------------- Matrix Xest ----------------------------------------------------------------------------\n\t\t\t');
fprintf([repmat('%.5f\t\t', 1, size(X_est, 2)) '\n\t\t\t'], X_est');

fprintf('\n\t\t----------------------------------------------------------------------------- Matrix Zest ----------------------------------------------------------------------------\n\t\t\t');
fprintf([repmat('%.5f\t\t', 1, size(Z_est, 2)) '\n\t\t\t'], Z_est');
